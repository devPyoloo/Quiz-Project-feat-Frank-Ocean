...
type QuestionChoicesProps = {
  choices: string[];
  handleSelectedChoice: (index: number) => void;
  selectedAnswer: number | null;
  correctIndex: number;
  showFeedBack: boolean;
}

export default function QuestionChoices({ choices, handleSelectedChoice, selectedAnswer, correctIndex, showFeedBack }: QuestionChoicesProps) {
  return (
